---
id: '724cb8a8443c6684bdcb632490655133'
title: 'Public Release Note'
url: 'https://knowledge.intershop.com/kb/index.php/Display/28776G'
scraped_at: '2026-04-21T05:37:58.801784+00:00'
---
...
The IOM Connector release package is available via Intershop's public Artifactory server. To add it to your release the following preconditions must be met:[Cookbook - Setup CI Infrastructure](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1822571078/Cookbook+-+Setup+CI+Infrastructure).## Precondition


Refer to [Cookbook - Setup CI Infrastructure](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1822571078/Cookbook+-+Setup+CI+Infrastructure) and to [Concept - Continuous Delivery Tools (valid to 7.10)](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1784317189) for basic information about Continuous Integration.[Dependency Version Information](https://knowledge.intershop.com#PublicReleaseNote-IOMConnector6.0-DependencyVersionInformation)
...
in the code example of section [Configure the Assembly](https://knowledge.intershop.com#PublicReleaseNote-IOMConnector6.0-ConfiguretheAssemblyConfiguretheAssembly)) and parts that are distributed as source (see `productionCartridges`

in the code example of section [Configure the Assembly](https://knowledge.intershop.com#PublicReleaseNote-IOMConnector6.0-ConfiguretheAssemblyConfiguretheAssembly)), so they can be copied and modified easily in a project. You can retrieve the source cartridges from your repository server *com.intershop.public.source.f_iomconnector *
...
The public delivery contains the exemplary assembly* inspired-connector.zip*. It can easily be used to get a first look.
...
In the same *build.gradle *file add the following two cartridges to `assemblyBuild.database`
...
To execute the database initialization used for a selected set of cartridges:
...
Also see [IOM Connector 4.0 - REST API - Get List of Documents of the Order](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1823700430/IOM+Connector+4.0+-+REST+API+-+Get+List+of+Documents+of+the+Order) for more information.
