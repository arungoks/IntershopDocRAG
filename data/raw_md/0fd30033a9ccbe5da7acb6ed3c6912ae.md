---
id: '0fd30033a9ccbe5da7acb6ed3c6912ae'
title: 'Guide'
url: 'https://knowledge.intershop.com/kb/index.php/Display/28682G'
scraped_at: '2026-04-21T05:30:13.743510+00:00'
---
...
The Suggest REST API with Solr returns by default a maximum of 20 search terms. The PWA search box component restricts the displayed search suggestions by default to 5, see [GitHub | Intershop PWA | Suggestion Feature](https://github.com/intershop/intershop-pwa/blob/develop/docs/guides/sparque-ai.md#suggestion-feature).

The number of displayed objects is configurable via the ish-search-box `maxAutoSuggests`

parameter in the [header-default.component.html](https://github.com/intershop/intershop-pwa/blob/d471f3fa3aee61247993bb4b551bc0b1a4a256a1/src/app/shell/header/header-default/header-default.component.html#L8).
...
Although the *SFProductSearchSuggest* stores information about the suggest types in its separate index, the suggest types are not yet available in the response of the Suggest Search REST API 2.0.1.
...
The current Suggest Search REST API 2.0.1 does not support returning structural information for different suggest types or additional information for direct links to product or category pages.
...
Restricted to provide search term suggestions Only prefix and lowercase matches | Dependent to other index builds Manual configuration necessary | A limited hard-coded set of supported attributes Dependency to other indexes Slower indexing time No OOTB PWA integration |
