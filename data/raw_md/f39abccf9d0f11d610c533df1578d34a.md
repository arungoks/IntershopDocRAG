---
id: 'f39abccf9d0f11d610c533df1578d34a'
title: 'Concept'
url: 'https://knowledge.intershop.com/kb/index.php/Display/M22583'
scraped_at: '2026-04-21T05:38:33.814966+00:00'
---
Note

This concept is valid to ICM version 7.10.11. For a later version of the document see [Concept - Configuration (valid from 7.10.12)](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1880271567).
...
cartridge |
| folder is predefined with ${IS_TARGET}/<cartridge-name>/release/config. The file name must match the `"matches"` attribute. The folder can be part of each source cartridge |
cartridge-folder |
| folder is predefined with |
...
With *Intershop 7* a new scope was introduced. The name of this scope is *service* and as it implies it is used for the [ Managed Service Framework.](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1759446169/Concept+-+Managed+Service+Framework)
