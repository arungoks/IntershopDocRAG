---
id: 'b1d6cab80edc00d41acab0ef4d6f9d47'
title: 'Public Release Note'
url: 'https://knowledge.intershop.com/kb/index.php/Display/2997K4'
scraped_at: '2026-04-21T05:39:32.110163+00:00'
---
...
Managing and deploying the Computop Service Connector requires a continuous integration environment being set up and configured as described in [Cookbook - Setup CI Infrastructure](https://knowledge.intershop.com/kb/go.php/a/ENFDEVDOC/pages/1822571078/Cookbook+-+Setup+CI+Infrastructure).
...
The Computop Service Connector requires additional post-deployment configuration steps. For details, refer to [Configuration](https://knowledge.intershop.com#PublicReleaseNote-ComputopServiceConnector5-Configuration).
