---
id: 'cbf3aebd40c1d613f110c78f67aa4d2f'
title: 'Concept'
url: 'https://knowledge.intershop.com/kb/index.php/Display/311R00'
scraped_at: '2026-04-21T05:35:02.415317+00:00'
---
...
|---|---|
| job | Specifies the name of the job as defined in the System Management Schedules module (mandatory). |
...
or<concurrent>. Specifies a pipeline to be executed within the chain. The next table lists the attributes for`<pipeline>`
...
| name | Specifies a display name for this pipeline to be used in the Monitoring | Locking | Processes module. |
...
Each task execution has a result that is indicated by a status. This status is represented by a "bit"-status by a enum (`ProcessChainStatus`

) value for each status. Parent processes can do a bitwise or to combine the status of their children.
