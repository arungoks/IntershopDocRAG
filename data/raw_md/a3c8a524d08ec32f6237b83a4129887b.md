...
|
| My Approvals | Approvers of B2B organizations can view the requisitions that are supposed to be processed or are already processed divided into the following areas: Approvers of B2B organizations can approve and reject requisitions. |
...
Content Management | |
| Pages | The following pages of the storefront can be managed by the integrated Content Management System:
|
...
Localization | |
| Manage Translations | All texts of the PWA can be managed and translated via the Intershop Commerce Management Backoffice. Text changes are immediately reflected within the PWA without the need for a deployment. |
Analytics | |
